...
function activate(context) {
    ...
    const runArgsCommand = vscode.commands.registerCommand("code-runner.runArgsCommand", (commandToExecute) => {
        codeManager.runArgsCommand(commandToExecute);
    });
    ...
    context.subscriptions.push(runArgsCommand);
